package ru.vsu.cs.pavlenkodm.struct;
...
public class BinaryTreeAlgorithms {
    ...
    public static double getMinValue(SimpleBinaryTree.SimpleTreeNode SimpleTreeNode) {
        if (SimpleTreeNode == null){
            return Integer.MIN_VALUE;
        }
        double res = (double) SimpleTreeNode.value;
        double leftRes = getMinValue(SimpleTreeNode.left);
        double rightRes = getMinValue(SimpleTreeNode.right);
        if (leftRes > res) {
            res = leftRes;
        }
        if (rightRes > res){
